...
object PreferencesRepository {
    ...
    // lazy - свойство prefs будет проинициализировано в момент первого обращения
    ...
    fun saveAppTheme(theme: Int) {
        Log.d("M_PreferencesRepository", "saveAppTheme $theme")
        putValue(APP_THEME to theme)
    }

    fun getAppTheme(): Int {
        Log.d(
            "M_PreferencesRepository",
            "getAppTheme ${prefs.getInt(APP_THEME, AppCompatDelegate.MODE_NIGHT_NO)}"
        )
